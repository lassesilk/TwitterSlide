...
//  TwitterSlideTest
//
//  Created by Lasse Silkoset on 07/12/2018.
...
class ChatroomMenuContainerController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        chatroomView.anchor(top: searchContainer.bottomAnchor, leading: view.safeAreaLayoutGuide.leadingAnchor, bottom: view.bottomAnchor, trailing: view.trailingAnchor)
    }
